...
import { WorkoutSession, ActiveExercise, WorkoutSet, WorkoutTemplate, Exercise } from './types';
      ...
      <div className="grid gap-6">
        {templates.map((t: any) => (
          <div key={t.id} className="relative group">
            <div className={`bg-gray-900 border border-gray-800 p-6 rounded-[2.5rem] shadow-xl transition-all ${isManage ? 'ring-2 ring-indigo-500/20' : 'hover:border-indigo-500/40 hover:bg-gray-900/50'}`}>
              <div className="flex justify-between items-start mb-6">
                {editingId === t.id ? (
                  <div className="flex gap-2 flex-1 animate-in slide-in-from-left-2">
                    ...
                    <button onClick={saveEditTemplate} className="bg-emerald-600 text-white p-2 rounded-xl shadow-lg shadow-emerald-600/10"><Check size={20}/></button>
                  </div>
                ) : (
